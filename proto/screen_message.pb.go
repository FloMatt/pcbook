...
type Screen struct {
	...
	Panel      Screen_Panel       `protobuf:"varint,3,opt,name=panel,proto3,enum=matt.pcbook.Screen_Panel" json:"panel,omitempty"`
...
var file_screen_message_proto_rawDesc = []byte{
	...
	0x1e, 0x2e, 0x6d, 0x61, 0x74, 0x74, 0x2e, 0x70, 0x63, 0x62, 0x6f, 0x6f, 0x6b, 0x2e, 0x53, 0x63,
	...
	0x61, 0x6e, 0x65, 0x6c, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x19, 0x2e, 0x6d, 0x61, 0x74,
	0x74, 0x2e, 0x70, 0x63, 0x62, 0x6f, 0x6f, 0x6b, 0x2e, 0x53, 0x63, 0x72, 0x65, 0x65, 0x6e, 0x2e,
	...
	0x02, 0x42, 0x0f, 0x5a, 0x0d, 0x2f, 0x68, 0x6f, 0x6d, 0x65, 0x2f, 0x6d, 0x61, 0x74, 0x74, 0x2f,
...
var file_screen_message_proto_goTypes = []any{
	(Screen_Panel)(0),         // 0: matt.pcbook.Screen.Panel
	(*Screen)(nil),            // 1: matt.pcbook.Screen
	(*Screen_Resolution)(nil), // 2: matt.pcbook.Screen.Resolution
}
var file_screen_message_proto_depIdxs = []int32{
	2, // 0: matt.pcbook.Screen.resolution:type_name -> matt.pcbook.Screen.Resolution
	0, // 1: matt.pcbook.Screen.panel:type_name -> matt.pcbook.Screen.Panel
