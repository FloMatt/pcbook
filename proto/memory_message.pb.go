...
type Memory struct {
	...
	Unit  Memory_Unit `protobuf:"varint,2,opt,name=unit,proto3,enum=matt.pcbook.Memory_Unit" json:"unit,omitempty"`
}
...
var file_memory_message_proto_rawDesc = []byte{
	...
	0x28, 0x0e, 0x32, 0x18, 0x2e, 0x6d, 0x61, 0x74, 0x74, 0x2e, 0x70, 0x63, 0x62, 0x6f, 0x6f, 0x6b,
	...
	0x10, 0x06, 0x42, 0x0f, 0x5a, 0x0d, 0x2f, 0x68, 0x6f, 0x6d, 0x65, 0x2f, 0x6d, 0x61, 0x74, 0x74,
...
var file_memory_message_proto_goTypes = []any{
	(Memory_Unit)(0), // 0: matt.pcbook.Memory.Unit
	(*Memory)(nil),   // 1: matt.pcbook.Memory
}
var file_memory_message_proto_depIdxs = []int32{
	0, // 0: matt.pcbook.Memory.unit:type_name -> matt.pcbook.Memory.Unit
