...
type Storage struct {
	...
	Driver Storage_Driver `protobuf:"varint,1,opt,name=driver,proto3,enum=matt.pcbook.Storage_Driver" json:"driver,omitempty"`
...
var file_storage_message_proto_rawDesc = []byte{
	...
	0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0b, 0x6d, 0x61, 0x74, 0x74, 0x2e, 0x70, 0x63,
	...
	0x18, 0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1b, 0x2e, 0x6d, 0x61, 0x74, 0x74, 0x2e, 0x70, 0x63,
	...
	0x65, 0x6d, 0x6f, 0x72, 0x79, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x13, 0x2e, 0x6d, 0x61,
	0x74, 0x74, 0x2e, 0x70, 0x63, 0x62, 0x6f, 0x6f, 0x6b, 0x2e, 0x4d, 0x65, 0x6d, 0x6f, 0x72, 0x79,
...
var file_storage_message_proto_goTypes = []any{
	(Storage_Driver)(0), // 0: matt.pcbook.Storage.Driver
	(*Storage)(nil),     // 1: matt.pcbook.Storage
	(*Memory)(nil),      // 2: matt.pcbook.Memory
}
var file_storage_message_proto_depIdxs = []int32{
	0, // 0: matt.pcbook.Storage.driver:type_name -> matt.pcbook.Storage.Driver
	2, // 1: matt.pcbook.Storage.memory:type_name -> matt.pcbook.Memory
