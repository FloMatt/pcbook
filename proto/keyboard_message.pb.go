...
type Keyboard struct {
	...
	Layout  Keyboard_Layout `protobuf:"varint,1,opt,name=layout,proto3,enum=matt.pcbook.Keyboard_Layout" json:"layout,omitempty"`
...
var file_keyboard_message_proto_rawDesc = []byte{
	...
	0x67, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0b, 0x6d, 0x61, 0x74, 0x74, 0x2e, 0x70,
	...
	0x28, 0x0e, 0x32, 0x1c, 0x2e, 0x6d, 0x61, 0x74, 0x74, 0x2e, 0x70, 0x63, 0x62, 0x6f, 0x6f, 0x6b,
	...
	0x02, 0x12, 0x0a, 0x0a, 0x06, 0x41, 0x5a, 0x45, 0x52, 0x54, 0x59, 0x10, 0x03, 0x42, 0x0f, 0x5a,
...
var file_keyboard_message_proto_goTypes = []any{
	(Keyboard_Layout)(0), // 0: matt.pcbook.Keyboard.Layout
	(*Keyboard)(nil),     // 1: matt.pcbook.Keyboard
}
var file_keyboard_message_proto_depIdxs = []int32{
	0, // 0: matt.pcbook.Keyboard.layout:type_name -> matt.pcbook.Keyboard.Layout
