...
var file_processor_message_proto_rawDesc = []byte{
	...
	0x61, 0x67, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0b, 0x6d, 0x61, 0x74, 0x74, 0x2e,
	...
	0x6f, 0x72, 0x79, 0x52, 0x06, 0x6d, 0x65, 0x6d, 0x6f, 0x72, 0x79, 0x42, 0x0f, 0x5a, 0x0d, 0x2f,
	0x68, 0x6f, 0x6d, 0x65, 0x2f, 0x6d, 0x61, 0x74, 0x74, 0x2f, 0x67, 0x6f, 0x62, 0x06, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x33,
}
...
var file_processor_message_proto_goTypes = []any{
	(*CPU)(nil),    // 0: matt.pcbook.CPU
	(*GPU)(nil),    // 1: matt.pcbook.GPU
	(*Memory)(nil), // 2: matt.pcbook.Memory
}
var file_processor_message_proto_depIdxs = []int32{
	2, // 0: matt.pcbook.GPU.memory:type_name -> matt.pcbook.Memory
